...
A RESTful API, custom validation functions, created route handlers, and built specific API endpoints. 
The front-end application was provided for this project.

## Links
- [App Demo](https://grubdash-client.onrender.com/)
- [App Documentation](https://github.com/everett442/grubdash-project)
